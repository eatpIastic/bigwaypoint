lets you make waypoints. you can put commands on those waypoints so if you click the waypoint it runs the command. you can have the waypoint display the command or not display the command.
